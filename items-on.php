...
$sql = "SELECT * FROM items_on WHERE id_user = '$id'";
...
$sql1 = "SELECT * FROM items_on WHERE id_user='$id' AND  id_item!='0'";
...
while ($row1 = mysql_fetch_array($result1)){
	...
	$defense.":".$health.":".$regen.":".$duration.":".$slot.":".$craft.":".$craft_items.":".$weapon_items.":".$price.":".$level.":".$row2['id_mob'].":".$row1['add_time']."<br />";
